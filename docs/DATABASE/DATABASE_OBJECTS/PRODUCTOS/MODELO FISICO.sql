...
ALTER TABLE productos
MODIFY COLUMN TIPO_PRODUCTO  VARCHAR(100);
ALTER TABLE productos
...
ALTER TABLE FRANJA_PRECIOS
ADD COLUMN FECHA_REGISTRO TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

SELECT * FROM FRANJA_PRECIOS ORDER BY FECHA_REGISTRO DESC;

CREATE TABLE IF NOT EXISTS TEXTO_COPIAR(
ID INT PRIMARY KEY AUTO_INCREMENT,
CODIGO VARCHAR(30) NOT NULL REFERENCES productos(CODIGO),
TEXTO_COPIAR TEXT NOT NULL
);
ALTER TABLE productos
...
ALTER TABLE FRANJA_PRECIOS
MODIFY COLUMN UNIDAD_MEDIDA_VENTA ENUM('DOCENA','UNIDAD','CAJA','PAR','CAJAS','PARES') NOT NULL;
ALTER TABLE FRANJA_PRECIOS
MODIFY COLUMN UNIDAD_MEDIDA_CAJA ENUM('DOCENA','UNIDAD','CAJA','PAR','CAJAS','PARES') NOT NULL;
