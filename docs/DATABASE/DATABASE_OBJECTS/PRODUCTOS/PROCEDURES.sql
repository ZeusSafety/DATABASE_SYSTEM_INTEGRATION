...
BEGIN
    ...
    ELSEIF METHOD = "OBTENER_PRECIO_PRODUCTO" THEN
        ...
        SELECT CODIGO, CONCAT(UNIDAD_MEDIDA_VENTA, " ", CANTIDAD_UNIDAD_MEDIDA_VENTA) AS MEDIDA,
...
CALL FRANJA_PRECIOS("OBTENER_PRECIO_PRODUCTO","GZ-AC10-9/MALVINAS");
...
select * from FRANJA_PRECIOS limit 20;
