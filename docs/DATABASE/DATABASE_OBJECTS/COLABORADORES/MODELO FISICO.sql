...
ALTER TABLE colaboradores
MODIFY COLUMN TIPO_DOCUMENTO ENUM('DNI','PASAPORTE');
ALTER TABLE colaboradores
MODIFY COLUMN NUMERO_DOCUMENTO INT;
ALTER TABLE colaboradores
...
SELECT * FROM IMAGENES_COLABORADOR;
SELECT ID_PERSONA, NOMBRE, CONTRASEÑA, CONTRASEÑA2 FROM colaboradores 
WHERE  CONTRASEÑA2 IS NULL
AND ESTADO = 1
ORDER BY ID_PERSONA DESC LIMIT 25;

UPDATE IMAGENES_COLABORADOR SET IMAGE_URL = "https://storage.googleapis.com/archivos_colaboradores/ZEUS_1/cd4b6822-070c-4b52-a5eb-e1c4747516da.jpeg"
WHERE ID = 1 AND ID_COLABORADOR = 1;
