...
END $$;
DELIMITER ;
CALL COLABORADORES2026("PERFIL_COLABORADOR", "hervinzeus");
...
SELECT C.NOMBRE, C.SEGUNDO_NOMBRE, C.APELLIDO, C.SEGUNDO_APELLIDO, FECHA_NACIMIENTO, C.TIPO_DOCUMENTO, C.NUMERO_DOCUMENTO,
...
WHERE C.ESTADO = 1
GROUP BY
C.NOMBRE, C.SEGUNDO_NOMBRE, C.APELLIDO, C.SEGUNDO_APELLIDO, FECHA_NACIMIENTO, C.TIPO_DOCUMENTO, C.NUMERO_DOCUMENTO,
HIJOS_BOOLEAN,CANT_HIJOS,ESTADO_CIVIL,
DIRECCION,GOOGLE_MAPS,
OCUPACION, CARGO,
SEGURO_VIDA_LEY,
