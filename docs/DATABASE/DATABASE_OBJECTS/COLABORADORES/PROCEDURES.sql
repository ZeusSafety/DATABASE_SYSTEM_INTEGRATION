...
SELECT C.NOMBRE, C.SEGUNDO_NOMBRE, C.APELLIDO, C.SEGUNDO_APELLIDO, FECHA_NACIMIENTO,
...
WHERE C.ESTADO = 1
GROUP BY C.NOMBRE, C.SEGUNDO_NOMBRE, C.APELLIDO, C.SEGUNDO_APELLIDO, FECHA_NACIMIENTO
LIMIT 10;