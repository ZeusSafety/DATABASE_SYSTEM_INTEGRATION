...
BEGIN
    ...
    ELSEIF AREA_IN = "FACTURACION" THEN
     WITH pdf as (
                ...
                SELECT I.ID_IMPORTACIONES, I.FECHA_REGISTRO,I.NUMERO_DESPACHO, ficha.ARCHIVO_PDF as ARCHIVO_PDF_URL, INCIDENCIAS, INCIDENCIA_REGISTRO, inci.ESTADO_INCIDENCIA AS ESTADO_VERIFICACION,ESTADO_REGISTRO_FACTURACION, FECHA_REGISTRO_FACTURACION, OBSERVACIONES_FACTURACION, RESPONSABLE
                                FROM IMPORTACIONES  as I
                                inner join ficha_importacion AS ficha
                                                ON ficha.ID = (SELECT MAX(ID) FROM pdf
                                                        WHERE NUMERO_DESPACHO=I.NUMERO_DESPACHO
